...
class Decoder (nn.Module):
    def __init__(self, num_classes, outputsize):
        super().__init__()
    ...
    def forward(self, input):
        ...
        out = interpolate(output, size=(self.outputsize, self.outputsize), mode="bilinear", align_corners=True)
...
# LEDNet
class Net(nn.Module):
    def __init__(self, num_classes,outputsize=480, encoder=None):
        super().__init__()
        ...
        self.decoder = Decoder(num_classes, outputsize)
